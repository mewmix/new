...
set_target_properties(RocksDB::rocksdb-shared PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/librocksdb.5.14.2.dylib"
  IMPORTED_SONAME_MINSIZEREL "@rpath/librocksdb.5.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS RocksDB::rocksdb-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_RocksDB::rocksdb-shared "${_IMPORT_PREFIX}/lib/librocksdb.5.14.2.dylib" )
